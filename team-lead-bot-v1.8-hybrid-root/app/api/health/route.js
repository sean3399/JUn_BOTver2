...
export async function GET() {
  return Response.json({
    ...
    blobConfigured: Boolean(process.env.BLOB_STORE_ID && process.env.BLOB_WEBHOOK_PUBLIC_KEY),
    blobAuthMode: process.env.BLOB_STORE_ID ? "oidc-presigned" : "not-configured",
