...
const SIDEBAR_ITEMS = [
  { name: "팀장님 (개인 시뮬레이터)", preview: "V1.8.4 · Assumption Trace", time: "지금", active: true, initials: "팀장" },
        ...
        <div className="bg-white border-b border-[#E1E1E1] px-5 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-[#616161] truncate">개인 시뮬레이터 · Adaptive Manager V1.8.4</div>
            </div>
          </div>
