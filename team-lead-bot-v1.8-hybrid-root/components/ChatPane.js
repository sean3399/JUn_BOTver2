...
const SIDEBAR_ITEMS = [
  { name: "팀장님 (개인 시뮬레이터)", preview: "V2.1.4 · Unified Blob + Visual Review", time: "지금", active: true, initials: "팀장" },
      ...
      <aside className="fixed lg:relative right-0 top-0 h-full w-[min(94vw,430px)] lg:w-[410px] shrink-0 bg-white border-l border-[#E1E1E1] z-30 shadow-xl lg:shadow-none flex flex-col">
        <div className="px-4 py-3 border-b border-[#E8E8E8] flex items-start justify-between gap-3">
          <div>
            ...
            <div className="text-[11px] text-[#777] mt-0.5">6축 점수 + 판단 OS + 근거 추적</div>
          </div>
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin px-4 py-4 space-y-5">
          ...
          <section>
            <div className="flex items-center justify-between mb-2">
              <div className="text-sm font-medium">팀장님 판단 OS</div>
          ...
          <section>
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-lg border border-[#E7E7E7] p-3">
                <div className="text-[11px] font-semibold mb-2">반복적으로 관찰된 판단 습관</div>
                <div className="space-y-1.5">
          ...
          <div className="text-[9px] leading-relaxed text-[#8A8886] border-t border-[#EEEEEE] pt-3">
            6축의 숫자는 통계적 확률이 아니라 실제 반응에서 추출한 규칙 기반 패턴 점수입니다. 판단 OS는 문서 점수와 별개로 팀장님의 반복적인 의사결정 태도를 보여줍니다. 첨부 문서는 현재 텍스트만 추출하므로 슬라이드의 색상·도형 배치·시각적 관계는 판정하지 않습니다.
          </div>
        </div>
      </aside>
    </>
        ...
        <div className="bg-white border-b border-[#E1E1E1] px-5 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-[#616161] truncate">개인 시뮬레이터 · Adaptive Manager V2.1 Beta</div>
            </div>
          </div>
            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto scrollbar-thin px-5 py-4 bg-white">
              ...
              {messages.length === 0 && (
                <div className="space-y-3 max-w-2xl">
                  <p className="text-sm text-[#616161]">보고서 파일을 첨부해서 검토받거나, 방향을 물어보세요. 팀장님 말풍선은 실제 채팅처럼 짧게 나오고, <HelpCircle size={12} className="inline -mt-0.5" />를 누르면 판단 OS·근거·6가지 축을 볼 수 있습니다.</p>
